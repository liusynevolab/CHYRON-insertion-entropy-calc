...
if lengthcount< 1:
	lengthcount = 1
insDict = {}
open('base_count_wells-64.txt','w').close()
with open(sys.argv[1]) as samples:
	for line in samples:
		...
		with open(withlengths) as lengths:
			...
			combinations = ["AAA","AAC","AAG","AAT","ACA","ACC","ACG","ACT","AGA","AGC","AGG","AGT","ATA","ATC","ATG","ATT","CAA","CAC","CAG","CAT","CCA","CCC","CCG","CCT","CGA","CGC","CGG","CGT","CTA","CTC","CTG","CTT","GAA","GAC","GAG","GAT","GCA","GCC","GCG","GCT","GGA","GGC","GGG","GGT","GTA","GTC","GTG","GTT","TAA","TAC","TAG","TAT","TCA","TCC","TCG","TCT","TGA","TGC","TGG","TGT","TTA","TTC","TTG","TTT"]
			combcount = [0] * 64
			for line in lengths:
				...
				if well in insDict[insertion]["counts"]: ## have we seen this insertion in this well?
					...
					insDict[insertion]["counts"][well] = insCount
			with open('base_count_wells-64.txt','a') as base_count:
